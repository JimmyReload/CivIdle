export const EN = {
   ...
   AbuSimbelDescV2: "Each level provides +100% Ramesses II's (Great Person) effect. All wonders within X tiles gain +1 Happiness. X = this wonder's level",
   ...
   Acropolis: "Acropolis",
   AcropoliumOfCarthage: "Acropolium of Carthage",
   ...
   Alloy: "Alloy",
   AllTransportsWithDistance3TileAreImmediate: "All transports with distance <= 3 tile are immediate",
   Ally: "Ally",
   AlpineLogistics: "Alpine Logistics",
   Alps: "Alps",
   AlpsDescV2: "Every 10th level of a building gives it +1 Production Multiplier",
   Aluminum: "Aluminum",
   ...
   AngkorWatDesc: "All buildings adjacent to Angkor Wat get +1 Worker Capacity Multiplier. Provide 1000 Workers",
   ...
   ApolloProgramDesc: "All rocket factories get +2 Production, Worker Capacity and Storage Multiplier. Satellite factories, spacecraft factories and nuclear missile silos get +1 Production Multiplier for each rocket factory they're adjacent to",
   ...
   ArcDeTriompheDescV2: "Every 1 happiness (capped at +50) provides +1 builder capacity to all buildings",
   ...
   AtlasMountainsDesc: "All buildings within 2 tile range get +X Production Multiplier. X = number of different resources produced but not consumed within the range",
   AtomicBomb: "Atomic Bomb",
   AtomicFacility: "Atomic Facility",
   AtomicTheory: "Atomic Theory",
   Atomium: "Atomium",
   AtomiumDescV2:
      "All buildings that produce science (except Clone Labs) within 2 tile range get +5 Production Multiplier. Generate science that is equal to the science production within 2 tile range of Atomium. When completed, generate one-time science equivalent to the cost of the most expensive unlocked technology",
   ...
   BerberAlliance: "Berber Alliance",
   BigBen: "Big Ben",
   BigBenDesc: "+2 Science From Busy Workers. Choose an empire ideology, unlock more boosts by upgrading",
   Binnenhof: "Binnenhof",
   Biplane: "Biplane",
   ...
   BlueMosqueDesc: "All wonders provide +1 Production, Worker Capacity and Storage Multiplier to adjacent buildings. When Blue Mosque is constructed next to Hagia Sophia, increase the bonus to +2",
   BobHope: "Bob Hope",
   ...
   BrandenburgGateDesc: "All coal mines and oil wells get +1 Production, Worker Capacity and Storage Multiplier. Oil refineries get +1 Production, Worker Capacity and Storage Multiplier for each oil tile adjacent to the refinery",
   Brasilia: "Brasília",
   Brazilian: "Brazilian",
   Bread: "Bread",
   Brewery: "Brewery",
   ...
   BritishMuseumDesc: "After constructed, can transform into to a unique constructed wonder from other civilizations",
   ...
   CaravansaryNetwork: "Caravansary Network",
   Caravel: "Caravel",
   ...
   Carnival: "Carnival: Capybara, Giant Otter, Hoatzin and Royal Flycatcher's range is increased to 3 tiles. Double the production multiplier from Cathedral of Brasília",
   CarryOverWatchedResources: "Carry Over Watched Resources",
   CarryOverWatchedResourcesIntoTheNextRunTheTabOnlyShowsAfterBuildingStatisticsOffice: "Carry over watched resources into the next run. The tab only shows after building Statistics Office",
   CarryOverWatchedTradeableResources: "Carry Over Watched Tradeable Resources",
   CarryOverWatchedTradeableResourcesIntoTheNextRunTheTabOnlyShowsAfterBuildingACaravansary: "Carry over watched tradeable resources into the next run. The tab only shows after building a Caravansary",
   Carthage: "Carthage",
   ...
   ChichenItzaDesc: "All buildings adjacent to Chichen Itza get +1 Production, Worker Capacity and Storage Multiplier",
   Chinese: "Chinese",
   ChoghaZanbil: "Chogha Zanbil",
   ChoghaZanbilDescV2: "Choose an empire tradition, unlock more boosts by upgrading",
   ...
   Church: "Church",
   ChurchOfCarthage: "Church of Carthage",
   CircusMaximus: "Circus Maximus",
   CircusMaximusDescV3: "+5X Happiness. All Musician's Guilds, Writer's Guilds, and Painter's Guilds gain +X Production and Storage Multipliers. X = this wonder's level",
   ...
   Cleopatra: "Cleopatra",
   ClickToUnlockThisIdea: "Click to unlock this idea",
   ...
   Colosseum: "Colosseum",
   ColosseumDescV3: "Chariot Workshops are exempt from the -1 Happiness penalty. Consumes 10X Chariots to produce +5X Happiness. Each unlocked age provides an additional +X Happiness. X = this wonder's level",
   ColossusOfRhodes: "Colossus of Rhodes",
   ColossusOfRhodesDesc: "All buildings adjacent to Colossus that do not produce workers get +1 Happiness",
   Combustion: "Combustion",
   Commerce4UpgradeHTMLV2: "When unlocked, all operational banks<b>adjacent to Chogha</b> get free upgrade to <b>level 30</b>",
   ...
   CothonOfCarthageLevel: "Cothon of Carthage Level",
   Cotton: "Cotton",
   CottonMill: "Cotton Mill",
   CottonPlantation: "Cotton Plantation",
   CouncilOfElders: "Council of Elders",
   Counting: "Counting",
   Courthouse: "Courthouse",
   CristoRedentor: "Cristo Redentor",
   CristoRedentorDesc: "All buildings within 2 tile range of Cristo Redentor are exempt from -1 Happiness",
   ...
   DinosaurProvincialParkDesc: "This wonder can be activated at a chosen time to gain a one-time Koti equal to %{percent} of the empire value at that time",
   ...
   Display5MasterpiecesToUnlock1BuildingLevelBoost: "Display 5 masterpieces to unlock +1 Building Level Boost",
   DisplayPaintingsBy5DifferentPaintersToUnlock1BuildingLevelBoost: "Display paintings by 5 different painters to unlock +1 Building Level Boost",
   DisplayPaintingsWith5DifferentThemesToUnlock1BuildingLevelBoost: "Display paintings with 5 different themes to unlock +1 Building Level Boost",
   DistanceInfinity: "Unlimited",
   DistanceInTiles: "Distance (In Tiles)",
   DiversificationBonus: "Diversification Bonus",
   ...
   EachLevelOfCothonOfCarthageProvides1IdeaPoint: "Each level of Cothon of Carthage provides 1 idea point",
   ...
   EffectiveGreatPeopleLevelDesc: "Effective great people level is the sum of all permanent great people levels and age wisdom levels. It measures the effective boost provided by great people and age wisdom",
   Egyptian: "Egyptian",
   ...
   ElbphilharmonieDesc: "All buildings within a 3-tile range get +1 Production Multiplier for each adjacent working building to them that has different tier",
   ...
   ElectrificationStatusDescV2: "Both buildings that require power and buildings that do not require power can be electrified. However, buildings that require power get +5 Building Level Boost for free",
   ...
   ExarchateOfAfrica: "Exarchate of Africa",
   ...
   FestivalOfTanit: "Festival of Tanit: Atlas Mountains get +2 range and also provide Building Level Boost",
   ...
   Gallery: "Gallery",
   GalleryPainterFransHals: "Frans Hals",
   GalleryPainterGeorgeHendrikBreitner: "George Hendrik Breitner",
   GalleryPainterJacobVanRuisdael: "Jacob van Ruisdael",
   GalleryPainterJanSteen: "Jan Steen",
   GalleryPainterJohannesVermeer: "Johannes Vermeer",
   GalleryPainterKarelAppel: "Karel Appel",
   GalleryPainterPieterBruegelTheElder: "Pieter Bruegel the Elder",
   GalleryPainterPieterDeHooch: "Pieter de Hooch",
   GalleryPainterPietMondrian: "Piet Mondrian",
   GalleryPainterRachelRuysch: "Rachel Ruysch",
   GalleryPainterRembrandtVanRijn: "Rembrandt van Rijn",
   GalleryPainterVincentVanGogh: "Vincent van Gogh",
   GalleryPaintingAMothersDuty: "A Mother's Duty",
   GalleryPaintingBroadwayBoogieWoogie: "Broadway Boogie Woogie",
   GalleryPaintingCafeTerraceAtNight: "Cafe Terrace at Night",
   GalleryPaintingCompositionWithRedBlueAndYellow: "Composition with Red, Blue, and Yellow",
   GalleryPaintingGirlInAWhiteKimono: "Girl in a White Kimono",
   GalleryPaintingGirlWithAPearlEarring: "Girl with a Pearl Earring",
   GalleryPaintingGrayTree: "Gray Tree",
   GalleryPaintingSelfPortrait1889: "Self Portrait (1889)",
   GalleryPaintingStillLifeWithFlowersOnAMarbleSlab: "Still Life with Flowers on a Marble Slab",
   GalleryPaintingSunflowers: "Sunflowers",
   GalleryPaintingTheAnatomyLessonOfDrNicolaesTulp: "The Anatomy Lesson of Dr Nicolaes Tulp",
   GalleryPaintingTheArtOfPainting: "The Art of Painting",
   GalleryPaintingTheBanquetOfTheOfficersOfTheStGeorgeMilitiaCompany: "The Banquet of the Officers of the St George Militia Company",
   GalleryPaintingTheCourtyardOfAHouseInDelft: "The Courtyard of a House in Delft",
   GalleryPaintingTheCryingCrocodileTriesToCatchTheSun: "The Crying Crocodile Tries to Catch the Sun",
   GalleryPaintingTheFeastOfSaintNicholas: "The Feast of Saint Nicholas",
   GalleryPaintingTheHuntersInTheSnow: "The Hunters in the Snow",
   GalleryPaintingTheJewishBride: "The Jewish Bride",
   GalleryPaintingTheLaughingCavalier: "The Laughing Cavalier",
   GalleryPaintingTheLittleStreet: "The Little Street",
   GalleryPaintingTheMerryFamily: "The Merry Family",
   GalleryPaintingTheMilkmaid: "The Milkmaid",
   GalleryPaintingTheNightWatch: "The Night Watch",
   GalleryPaintingThePotatoEaters: "The Potato Eaters",
   GalleryPaintingTheSingelBridgeAtThePaleisstraatInAmsterdam: "The Singel Bridge at the Paleisstraat in Amsterdam",
   GalleryPaintingTheStarryNight: "The Starry Night",
   GalleryPaintingViewOfHaarlemWithBleachingFields: "View of Haarlem with Bleaching Fields",
   GalleryPaintingWheatFieldWithCrows: "Wheat Field with Crows",
   GalleryPaintingWindmillAtWijkBijDuurstede: "Windmill at Wijk bij Duurstede",
   GalleryPaintingWomanHoldingABalance: "Woman Holding a Balance",
   GalleryThemeAbstract: "Abstract",
   GalleryThemeDomesticScene: "Domestic Scene",
   GalleryThemeLandscapeCityscape: "Landscape/Cityscape",
   GalleryThemePortrait: "Portrait",
   GalleryThemeStillLife: "Still Life",
   ...
   GenerateOneTimeKotiEqualToXOfTheTotalEmpireValue: "Generate one-time Koti equal to %{percent} of the total empire value",
   ...
   GoldenPavilionDesc: "All buildings within 3 tile range get +1 Production Multiplier for each building adjacent to it that produces any of its consumed resources (excluding Clone Lab and Clone Factory and the building cannot be turned off)",
   GoldMiningCamp: "Gold Mining Camp",
   GordonMoore: "Gordon Moore",
   GranaryAdministration: "Granary Administration",
   ...
   GrandCanyonDesc: "While in each age, buildings unlocked in that age get +2 Production Multiplier. Double the effect of J.P. Morgan",
   GraphicsDriver: "Graphics Driver: %{driver}",
   GreatBarrierReef: "Great Barrier Reef",
   GreatBarrierReefDesc: "Each happiness (capped at 50) provides +0.2*X Science Per Busy Worker and +0.1*X Science Per Idle Worker. X = Current Age (Stone Age = 1, Bronze Age = 2, Information Age = 10)",
   ...
   GreatSphinxDescV3: "All buildings within X tiles gain +N Production Multiplier. For each affected building, N is the number of adjacent buildings of the same type. X = this wonder's level",
   GreatWall: "Great Wall",
   GreatWallDescV2: "All buildings within X tiles gain +N Production, Worker Capacity, and Storage Multipliers. N is the difference between the current age and the age in which the building is unlocked. X = this wonder's level. Building it next to Forbidden City increases its range by 1 tile",
   GreedyTransport: "Construction/Upgrade Greedy Transport",
   GreedyTransportDescHTML: "This will make buildings keep transporting resources even if they have enough resources for the current upgrade, which can make upgrading multiple levels <b>faster</b> but end up transporting <b>more resources than needed</b>",
   Greek: "Greek",
   GrottaAzzurra: "Grotta Azzurra",
   GrottaAzzurraDescV2: "When discovered, all your Tier I buildings get +5 Levels and +1 Production, Worker Capacity and Storage Multiplier",
   Gunpowder: "Gunpowder",
   ...
   Habitat67DescV2: "This wonder can be upgraded and each level provides +1 Production, Worker Capacity and Storage Multiplier to AI Labs. Provides +1 Production and Storage Multiplier to AI Lab for each level of Information Age Wisdom. Provides +1 Building Level Boost to AI Labs for every 5 happiness (capped)",
   HafsidDynasty: "Hafsid Dynasty",
   HagiaSophia: "Hagia Sophia",
   HagiaSophiaDescV2: "+5 Happiness. Buildings with 0% Production Capacity are exempt from -1 happiness. During the game bootstrap(startup), provide temporary extra happiness to avoid production halt",
   HallOfFame: "Hall of Fame",
   HallOfSupremeHarmony: "Hall of Supreme Harmony",
   Hammurabi: "Hammurabi",
   HangingGarden: "Hanging Garden",
   HangingGardenDesc: "+1 Builder Capacity Multiplier. Aqueducts adjacent to Hanging Gardens get +1 Production, Worker Capacity and Storage Multiplier",
   Hannibal: "Hannibal",
   HannibalSStrategy: "Hannibal's Strategy",
   ...
   HarborWarehouse: "Harbor Warehouse",
   ...
   HillfortSettlements: "Hillfort Settlements",
   ...
   Hollywood: "Hollywood",
   HollywoodDesc: "+5 Happiness. +1 Happiness for each well-stocked building that consumes or produces culture within a 2 tile range",
   ...
   IberianColonies: "Iberian Colonies",
   IdeologyDescHTML: "Choose from <b>Liberalism, Conservatism, Socialism or Communism</b> as your empire ideology for this rebirth. You <b>cannot switch ideology</b> after it is chosen. You can unlock more boost within each ideology",
   IMPei: "I. M. Pei",
   ...
   IronTech: "Iron",
   IrrigatedEstate: "Irrigated Estate",
   ...
   ItaipuDamDesc: "This wonder can be upgraded and each level can be used to either give +1 Production Multiplier or +1 Building Level Boost to buildings within 2 tile range. Provides power to all tiles within 2 tile range",
   ...
   Justinian: "Justinian",
   Kanagawa: "Kanagawa",
   KanagawaDesc: "While in each age, all great people of that age get an additional level for this run (excluding Zenobia)",
   KarlMarx: "Karl Marx",
   KeeperOfOurServer: "Keeper Of Our Server",
   KeeperOfOurServerThankYou: "CivIdle is kept afloat thanks to the generosity of the following keepers of our server",
   ...
   Keukenhof: "Keukenhof",
   KeukenhofDescV2: "+X Happiness. X = number of different resources produced or consumed within 3 tile range",
   KingDavid: "King David",
   KizhiPogost: "Kizhi Pogost",
   KizhiPogostDescV2: "All buildings within 3-tile range get +X Production Multiplier. X = the production multiplier this wonder receives",
   Knight: "Knight",
   ...
   LighthouseOfAlexandriaDesc: "All buildings adjacent to Lighthouse get +5 Storage Multiplier",
   LinusPauling: "Linus Pauling",
   LinusPaulingDesc: "+%{value} Science From Idle Workers",
   Literature: "Literature",
   LiveData: "Live Value",
   LockTradeProfit: "Lock Trade Profit",
   ...
   LuxorTempleDescV2: "+1 Science From Busy Workers. Choose an empire religion, unlock more boosts by upgrading",
   Machinery: "Machinery",
   Magazine: "Magazine",
   ...
   Market: "Market",
   MarketDesc: "Exchange a resource for another, available resources update every hour",
   ...
   MausoleumAtHalicarnassusDescV2: "Transports from or to buildings within a 2-tile range of the Mausoleum do not cost workers",
   MaxExplorers: "Max Explorers",
   MaxOfflineProductionTimeDesc: "Max Offline Production Time is %{time}. The rest is converted to Time Warp",
   MaxTariff: "Max Tariff",
   MaxTransportDistance: "Max Transport Distance",
   Meat: "Meat",
   MedinaOfTunis: "Medina of Tunis",
   MediterraneanTrades: "Mediterranean Trades",
   MercenaryCommand: "Mercenary Command",
   ...
   Milk: "Milk",
   MinusXResearchCost: "-%{percent} Research Cost",
   ...
   MountAraratDesc: "All buildings within 2 tile range of Ararat get +X Production, Worker Capacity and Storage Multiplier. X = cubic root of Effective Great People Level",
   ...
   MoveBuildingSelectTile: "Select A Tile...",
   MoveBuildingSelectTileToastHTML: "Select <b>an empty explored tile</b> on the map as the target",
   MoveTileConfirm: "Are you sure you want to claim this tile? Your occupied tiles will be lost and you cannot claim a new tile for %{time} hours.",
   Movie: "Movie",
   ...
   NavalSiegecraft: "Naval Siegecraft",
   ...
   NileRiverDesc: "Double the effect of Hatshepsut (Great Person). All wheat farms get +1 Production and Storage Multiplier. All wheat farms adjacent to Nile River get +5 Production and Storage Multiplier",
   ...
   OpetV3: "Opet: Great Sphinx also grants each affected building a Building Level Boost equal to the Production Multiplier it provides",
   ...
   OxfordUniversityDescV3: "Generates science equal to 10% of the science output of buildings that produce science. When completed, generate one-time science equivalent to the cost of the most expensive unlocked technology",
   ...
   Pamukkale: "Pamukkale",
   PamukkaleDesc: "When discovered, for each Permanent Great Person that has at least one unspent shard (except for Promotion and Wildcard) consume that shard to give +1 in-run selection of that Great Person",
   Panathenaea: "Panathenaea: Poseidon provides +1 Production Multiplier to all buildings",
   Pantheon: "Pantheon",
   PantheonDescV2: "All buildings within 2 tile range of Pantheon get +1 Worker Capacity and Storage Multiplier. Generate science based on faith production of all shrines",
   Paper: "Paper",
   PaperMaker: "Paper Maker",
   Parliament: "Parliament",
   ParliamentHill: "Parliament Hill",
   Parthenon: "Parthenon",
   ParthenonDescV3: "Each level provides 2 Classical Age Great People, with 4 choices for each. Musician's Guilds and Painter's Guilds gain +1 Production, Worker Capacity, and Storage Multipliers and are exempt from the -1 Happiness penalty",
   Passcode: "Passcode",
   ...
   PhoenicianAlphabet: "Phoenician Alphabet",
   Physics: "Physics",
   PierreDeCoubertin: "Pierre de Coubertin",
   PincerMovement: "Pincer Movement",
   ...
   PlayerMapTariffDesc: "Every trade that goes through your tile will pay a tariff to you. It's a balance: if you increase the tariff, the more you will gain from each trade, but fewer trades will go through your tile.",
   ...
   Plus2RangeForBuildings: "+2 range for %{buildings}",
   PlusAtlasMountainsRange: "+%{range} Atlas Mountains range",
   PlusXAgeWisdom: "+%{percent} %{age} Wisdom",
   PlusXBaseStorageForMarketWarehouseAndCaravansary: "+%{percent} Base Storage for Market, Warehouse and Caravansary",
   ...
   PorcelainTowerMaxPickPerRollDescHTML: "When choosing great people after Porcelain Tower is completed, prefer max pick per roll for the available amount",
   ...
   Poseidon: "Poseidon",
   PoseidonDescV2: "All buildings adjacent to Poseidon get free upgrades to Level 25 and +N Production, Worker Capacity and Storage Multiplier. N = Tier of the building",
   ...
   Progress: "Progress",
   ProgressTowardsNextGreatPerson: "Progress Towards Next Extra Great Person at Rebirth",
   ProgressTowardsTheNextGreatPerson: "Progress Towards the Next Great Person",
   PromotionGreatPersonDescV2: "Consume, along with a shard of any Great Person of this age, to become a shard of any Great Person of the next age",
   ...
   ProvinceOfIfriqiya: "Province of Ifriqiya",
   ...
   PunicCoinage: "Punic Coinage",
   PunicGoldenAge: "Punic Golden Age",
   PunicLegalCodex: "Punic Legal Codex",
   PurpleDyeMonopoly: "Purple Dye Monopoly",
   ...
   RebirthHistoryEmpireValuePerCycle: "EV/Cycle",
   RebirthHistoryEmpireValuePerWallSecond: "EV/Second",
   ...
   Reborn: "Rebirth",
   RebornModalDescV3: "You will start a new empire but all your great people <b>from this run</b> become permanent shards, which can be used to upgrade your <b>permanent great people level</b>. You will also get extra great people shards based on your <b>total empire value</b>",
   ...
   RedFort: "Red Fort",
   RedFortDesc: "+1 Building Level Boost to all buildings within 3-tile range of the Fort. This wonder can be upgraded and each additional level provides an extra +1 Building Level Boost",
   ...
   ReligionDescHTML: "Choose from <b>Christianity, Islam, Buddhism or Polytheism</b> as your empire religion for this rebirth. You <b>cannot switch religion</b> after it is chosen. You can unlock more boosts by upgrading",
   ReligionIslam: "Islam",
   ...
   RememberLastBuildRange: "Remember Last Build Range",
   RememberTheLastSelectedBuildRangeAfterYouBuildInRangeTheValueIsRememberedDuringTheCurrentGameSession: "Remember the last selected build range after you build in range - the value is remembered during the current game session",
   ...
   RequiredWorkersTooltipV2: "The base number of workers required for production is equal to the sum of all resources consumed and produced after multipliers (excluding dynamic multipliers)",
   ...
   RestitutorDescHTML:
      "Wishlist my upcoming game - <b>Restitutor: Empire Restored</b>. It is a historical incremental grand strategy game focused on <i>statecraft, diplomacy, and calculated warfare</i>. Set in the Roman Empire after the death of Commodus in 192 AD, when the empire fractures into rival provinces. As a governor, lead a province of your choice and restore the empire.",
   ...
   RhineGorgeDesc: "+2 Happiness for each wonder within 2 tile range of the Gorge",
   ...
   RiseOfPunic: "Rise of Punic",
   RitualSanctuaries: "Ritual Sanctuaries",
   ...
   SagradaFamiliaDesc: "All buildings within 2 tile range of Sagrada get +N Production, Worker Capacity and Storage Multipliers. N = max tier difference among buildings adjacent (1 tile range) to the Sagrada Familia",
   SaintBasilsCathedral: "Saint Basil's Cathedral",
   SaintBasilsCathedralDescV2: "Allow resource extraction buildings to work adjacent to their deposit. All Tier I buildings adjacent to St. Basil's get +1 Production, Worker Capacity and Storage Multiplier",
   Saladin: "Saladin",
   ...
   SummerPalaceDesc: "All buildings adjacent to the Palace that consume or produce Gunpowder are exempt from -1 Happiness. All buildings that consume or produce Gunpowder get +1 Production, Worker Capacity and Storage Multiplier",
   ...
   SupporterThankYou: "CivIdle is kept afloat thanks to the generosity of the following supporter pack owners",
   Surplus: "Surplus",
   SwissBank: "Swiss Bank",
   SwissBankDescV3:
      "Convert a chosen resource from player tradeable resources (currently in a Caravansary or a Warehouse adjacent to one) to Koti (10 million in Sanskrit). Each level of Swiss Bank adds 1 Koti conversion per cycle, which is affected by Production Multiplier. Swiss Bank can store an unlimited amount of Koti",
   Sword: "Sword",
   ...
   ThePentagonDesc: "Once constructed, generate teleports that can be used to move buildings. All buildings within 2 tile range of The Pentagon get +1 Production, Worker Capacity and Storage Multiplier",
   ...
   TimeWarp: "Time Warp",
   TimeWarpWarning: "Accelerating at a higher speed than your computer can handle might result in data loss: USE AT YOUR OWN RISK",
   Today: "Today",
   ...
   TopkapiPalaceDesc: "All buildings within 2 tile range of the Palace get +X Storage Multiplier. X = 50% of its Production Multiplier (excluding Dynamic)",
   ...
   TotalWallTimeThisRunTooltip: "Real time (aka. wall time) measures the actual time taken for this run. The differs from the game time in that Time Warp in Petra and Offline Production do not affect real time but they do affect game time",
   TotalWorkers: "Total Workers",
   TowerBridge: "Tower Bridge",
   TowerBridgeDesc: "Once constructed, a great person from unlocked ages is born every 3600 cycles (1h game time)",
   ...
   TraditionDescHTML: "Choose from <b>Cultivation, Commerce, Expansion or Honor</b> as your empire tradition for this rebirth. You <b>cannot switch tradition</b> after it is chosen. You can unlock more boosts by upgrading",
   ...
   TreatyDiplomacy: "Treaty Diplomacy",
   ...
   TutorialBuildLumberMillsHTML: "Lumber Mills consume Wood, and produce Lumber, which is an important construction material. Make sure you have enough Logging Camps to supply them - you can use Statistics Office to help balance your production and consumption.",
   ...
   TutorialRebirthHTML: "When the progress feels slow, you should consider rebirthing. When rebirthing, the great people from this run become permanent great people shards, which can be used to upgrade permanent great people. You can choose a different civilization - each civilization has its own unique content.",
   ...
   TutorialResearchHousingHTML:
      "Researching Housing tech to unlock <b>House</b>, which provides more workers than huts. After researching Housing, your empire will enter <b>Bronze Age</b>, and a Bronze Age great person will be born. You can choose one from three choices - a great person provides significant boost - choose wisely.",
   TutorialResearchLandTradeTechHTML: "By researching Land Trade your empire will enter Iron Age. You can pick a great person from Iron Age and Bronze Age. Land Trade tech also unlocks Caravansary.",
   ...
   Uluru: "Uluru",
   UluruDesc: "All buildings that do not produce workers within 2-tile range of Uluru get +0.5*X Production Multiplier. X = number of different great people from this run",
   ...
   WallStreetDesc: "All buildings that produce coin, banknote, bond, stock or forex within 2 tile range of Wall Street get +N production multiplier. N = Random value between 1 and 5 which is different per building and changes with every hourly market refresh. Double the effect of John D. Rockefeller",
   ...
   Water: "Water",
   WellStockedTooltip: "Well-stocked buildings are buildings that have enough resources for their production, which includes buildings that are producing, that have full storage or not producing due to lack of workers",
   WernherVonBraun: "Wernher von Braun",
   Westminster: "Westminster",
   Wheat: "Wheat",
   WheatFarm: "Wheat Farm",
   WildCardGreatPersonDescV2: "Consume to become a shard of any great person of the same age",
   ...
   Wonder: "Wonder",
   WonderBuilderCapacityDescHTML: "<b>Builder Capacity</b> when constructing wonders is affected by the <b>age</b> and <b>technology</b> that unlocks the wonder",
   ...
   XDifferentMasterpieces: "%{count} Different Masterpieces",
   XDifferentPainters: "%{count} Different Painters",
   XDifferentThemes: "%{count} Different Themes",
   XhWarpStorageThisRun: "+%{hour}h Warp Storage this run",
   ...
   ZagrosMountainsDesc: "All buildings adjacent to Zagros that have less than 5 Production Multiplier get +2 Production Multiplier. Double the effect of Nebuchadnezzar II (Great Person)",
   ...
   ZigguratOfUrDescV2: "Every 10 happiness (capped) provides +1 Production Multiplier to all buildings that do not produce workers and are unlocked in previous ages to the current age (max = number of unlocked ages / 2). Wonders (incl. Natural) no longer provide +1 Happiness. The effect can be turned off",
   Zoroaster: "Zoroaster",
   Zugspitze: "Zugspitze",
